...
HTML_LOCALES = {
    "ru": {
        ...
        "new_wallet":          f"{e['gem']} <b>Кошелёк должен начинаться с UQ или EQ (латиница, цифры, _ -).</b>",
        "new_card":            f"{e['card']} <b>Введите 16 цифр карты.</b>",
        ...
        "invalid_btc_wallet":      f"{e['cross3']} <b>Введите корректный Bitcoin-адрес (начинается с bc1q, 1 или 3).</b>",
        "invalid_card":            f"{e['cross2']} <b>Введите 16 цифр карты.</b>",
        "invalid_stars_username":  f"{e['cross3']} <b>Неверный @username.</b>",
...
# Final requisites prompts: exact wording requested by the user.
_REQ_FINAL = {
"ru": {
    "new_wallet":"💎 <b>Кошелёк должен начинаться с UQ или EQ (латиница, цифры, _ -).</b>",
    "new_card":"💳 <b>Введите 16 цифр карты.</b>",
    "new_stars_username":"⭐ <b>Введите @username для Stars (без @).</b>",
    "new_usdt_wallet":"🪙 <b>Введите корректный USDT-адрес TRC20 (начинается с T).</b>",
    "new_btc_wallet":"₿ <b>Введите корректный Bitcoin-адрес (начинается с bc1q, 1 или 3).</b>",
    "invalid_wallet":"❌ <b>Кошелёк должен начинаться с UQ или EQ (латиница, цифры, _ -).</b>",
    "invalid_card":"❌ <b>Введите 16 цифр карты.</b>",
    "invalid_stars_username":"❌ <b>Неверный @username.</b>",
    ...
    "edit_stars":"Stars username",
},
"en": {
    "new_wallet":"💎 <b>Wallet must start with UQ or EQ (Latin letters, digits, _ -).</b>",
    "new_card":"💳 <b>Enter 16 card digits.</b>",
    "new_stars_username":"⭐ <b>Enter the Stars @username (without @).</b>",
    "new_usdt_wallet":"🪙 <b>Enter a valid USDT TRC20 address (starts with T).</b>",
    "new_btc_wallet":"₿ <b>Enter a valid Bitcoin address (starts with bc1q, 1 or 3).</b>",
    "invalid_wallet":"❌ <b>Wallet must start with UQ or EQ (Latin letters, digits, _ -).</b>",
    "invalid_card":"❌ <b>Enter 16 card digits.</b>",
    "invalid_stars_username":"❌ <b>Invalid @username.</b>",
...
"uk": {
    "new_wallet":"💎 <b>Гаманець має починатися з UQ або EQ (латиниця, цифри, _ -).</b>",
    "new_card":"💳 <b>Введіть 16 цифр картки.</b>",
    "new_stars_username":"⭐ <b>Введіть @username для Stars (без @).</b>",
    "new_usdt_wallet":"🪙 <b>Введіть коректну USDT-адресу TRC20 (починається з T).</b>",
    "new_btc_wallet":"₿ <b>Введіть коректну Bitcoin-адресу (починається з bc1q, 1 або 3).</b>",
    "invalid_wallet":"❌ <b>Гаманець має починатися з UQ або EQ (латиниця, цифри, _ -).</b>",
    "invalid_card":"❌ <b>Введіть 16 цифр картки.</b>",
    "invalid_stars_username":"❌ <b>Невірний @username.</b>",
    "invalid_usdt_wallet":"❌ <b>Введіть коректну USDT-адресу TRC20 (починається з T).</b>",
    "invalid_btc_wallet":"❌ <b>Введіть коректну Bitcoin-адресу (починається з bc1q, 1 або 3).</b>",
    "edit_stars":"Stars username",
},
"kk": {
    "new_wallet":"💎 <b>Әмиян UQ немесе EQ арқылы басталуы керек (латиница, сандар, _ -).</b>",
    "new_card":"💳 <b>Картаның 16 цифрын енгізіңіз.</b>",
    "new_stars_username":"⭐ <b>Stars үшін @username енгізіңіз (@ белгісінсіз).</b>",
    "new_usdt_wallet":"🪙 <b>Дұрыс USDT TRC20 мекенжайын енгізіңіз (T әрпінен басталады).</b>",
    "new_btc_wallet":"₿ <b>Дұрыс Bitcoin мекенжайын енгізіңіз (bc1q, 1 немесе 3-тен басталады).</b>",
    "invalid_wallet":"❌ <b>Әмиян UQ немесе EQ арқылы басталуы керек (латиница, сандар, _ -).</b>",
    "invalid_card":"❌ <b>Картаның 16 цифрын енгізіңіз.</b>",
    "invalid_stars_username":"❌ <b>Қате @username.</b>",
    "invalid_usdt_wallet":"❌ <b>Дұрыс USDT TRC20 мекенжайын енгізіңіз (T әрпінен басталады).</b>",
    "invalid_btc_wallet":"❌ <b>Дұрыс Bitcoin мекенжайын енгізіңіз (bc1q, 1 немесе 3-тен басталады).</b>",
    "edit_stars":"Stars username",
},
"zh": {
    "new_wallet":"💎 <b>钱包必须以 UQ 或 EQ 开头（拉丁字母、数字、_ -）。</b>",
    "new_card":"💳 <b>请输入16位银行卡号。</b>",
    "new_stars_username":"⭐ <b>请输入 Stars 的 @username（不含 @）。</b>",
    "new_usdt_wallet":"🪙 <b>请输入正确的 USDT TRC20 地址（以 T 开头）。</b>",
    "new_btc_wallet":"₿ <b>请输入正确的 Bitcoin 地址（以 bc1q、1 或 3 开头）。</b>",
    "invalid_wallet":"❌ <b>钱包必须以 UQ 或 EQ 开头（拉丁字母、数字、_ -）。</b>",
    "invalid_card":"❌ <b>请输入16位银行卡号。</b>",
    "invalid_stars_username":"❌ <b>@username 无效。</b>",
    "invalid_usdt_wallet":"❌ <b>请输入正确的 USDT TRC20 地址（以 T 开头）。</b>",
    "invalid_btc_wallet":"❌ <b>请输入正确的 Bitcoin 地址（以 bc1q、1 或 3 开头）。</b>",
    "edit_stars":"Stars username",
},
"hi": {
    "new_wallet":"💎 <b>वॉलेट UQ या EQ से शुरू होना चाहिए (Latin अक्षर, अंक, _ -)।</b>",
    "new_card":"💳 <b>कार्ड के 16 अंक दर्ज करें।</b>",
    "new_stars_username":"⭐ <b>Stars का @username दर्ज करें (@ के बिना)।</b>",
    "new_usdt_wallet":"🪙 <b>सही USDT TRC20 पता दर्ज करें (T से शुरू होता है)।</b>",
    "new_btc_wallet":"₿ <b>सही Bitcoin पता दर्ज करें (bc1q, 1 या 3 से शुरू होता है)।</b>",
    "invalid_wallet":"❌ <b>वॉलेट UQ या EQ से शुरू होना चाहिए (Latin अक्षर, अंक, _ -)।</b>",
    "invalid_card":"❌ <b>कार्ड के 16 अंक दर्ज करें।</b>",
    "invalid_stars_username":"❌ <b>गलत @username।</b>",
...
for _lang, _vals in _REQ_FINAL.items():
    HTML_LOCALES.setdefault(_lang, {}).update(_vals)
